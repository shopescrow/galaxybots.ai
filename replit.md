...
- `client_integrations` — Per-client OAuth tokens/API keys for external services (Gmail, Google Calendar, HubSpot, Notion). Referenced by clientId with cascade delete.
...
10. **Integrations Settings** — Client-facing integrations page at `/integrations`
    - Per-client credential management for Gmail, Google Calendar, HubSpot, Notion
...
11. **Compliance Center** — Two-sided compliance management at `/compliance`
