        ...
        <div style={{ display: "flex", gap: "8vw", flex: 1, alignItems: "flex-start" }}>
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "2.5vh" }}>
            <div style={{ display: "flex", gap: "2vw", alignItems: "center" }}>
              ...
              <div style={{ fontFamily: "Inter", fontSize: "1.7vw", color: "#E8EAF0" }}>Navigate to Bots in the left sidebar</div>
            </div>
            <div style={{ display: "flex", gap: "2vw", alignItems: "center" }}>
              ...
              <div style={{ fontFamily: "Inter", fontSize: "1.7vw", color: "#E8EAF0" }}>Select the specialist you need</div>
            </div>
            <div style={{ display: "flex", gap: "2vw", alignItems: "center" }}>
              <div style={{ minWidth: "3.5vw", height: "3.5vw", borderRadius: "50%", background: "rgba(212,168,83,0.15)", border: "1px solid rgba(212,168,83,0.4)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Outfit", fontWeight: 700, fontSize: "1.5vw", color: "#D4A853" }}>3</div>
              <div style={{ fontFamily: "Inter", fontSize: "1.7vw", color: "#E8EAF0" }}>Click "Open Channel"</div>
            </div>
            <div style={{ display: "flex", gap: "2vw", alignItems: "center" }}>
              <div style={{ minWidth: "3.5vw", height: "3.5vw", borderRadius: "50%", background: "rgba(61,127,232,0.2)", border: "1px solid rgba(61,127,232,0.5)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Outfit", fontWeight: 700, fontSize: "1.5vw", color: "#3D7FE8" }}>4</div>
              <div style={{ fontFamily: "Inter", fontSize: "1.7vw", color: "#E8EAF0", fontWeight: 500 }}>Your secure line is live</div>
            </div>
          ...
          <div style={{ width: "28vw", background: "#0E1029", border: "1px solid rgba(212,168,83,0.2)", borderRadius: "1.2vw", padding: "3vh 2.5vw", flexShrink: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1.5vw", marginBottom: "2.5vh" }}>
              <div style={{ width: "5vw", height: "5vw", borderRadius: "50%", background: "rgba(212,168,83,0.12)", border: "1px solid rgba(212,168,83,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span style={{ fontFamily: "Outfit", fontWeight: 800, fontSize: "1.3vw", color: "#D4A853" }}>CMO</span>
              </div>
              <div>
